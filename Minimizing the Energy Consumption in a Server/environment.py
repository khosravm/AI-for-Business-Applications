...
class Environment(object):
    ...
    def __init__(self, optimal_temperature = (18.0, 24.0), initial_month = 0, initial_number_users = 10, initial_rate_data = 60):
        ...
        self.reward = 0.0
        self.game_over = 0 # 1 if it is over and 0 if it is not
        self.train = 1     # and 0 if it is not in train mode
    ...
    def update_env(self, direction, energy_ai, month):
        ...
        # Scaling the Reward (It is not an obligation but it is highly recommended)
        ...
        # GETTING GAME OVER (To end this eoisode as soon as our AI is far from its goal)
        ...
        # SCALING THE NEXT STATE (State vector is the input of our ANN, and it is better to scale (normalize) its elements!)
